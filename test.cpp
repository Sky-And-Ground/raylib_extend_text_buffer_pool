...
int main(void) 
{
    ...
    // render our needed characters. and be cautions here, we also include a space and a comma.
    TextData data;
    ...
    while (!WindowShouldClose()) 
    {
        ...
        DrawTextEx(data.font().value(), "这是一段文本, 专用于测试", (Vector2){ 50, 50 }, 32, 0, RED);  // draw it.
        EndDrawing();
    }
